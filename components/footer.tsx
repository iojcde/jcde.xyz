...
const Footer: React.FC = () => {
  return (
    <footer className="relative pt-8 max-w-3xl mx-auto  z-10 w-full  pb-4 font-light text-gray-600  dark:text-gray-200 tracking-wide">
      <hr />
      <div className=" pt-4 grid grid-cols-3 gap-4 grid-flow-row max-w-lg mx-auto text-sm text-center pb-5">
        ...
        <Link href="https://lab.jcde.xyz/jcdea">Gitlab</Link>
